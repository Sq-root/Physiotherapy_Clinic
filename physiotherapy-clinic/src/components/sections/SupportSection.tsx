...
export function SupportSection() {
  ...
  return (
    <section className="relative bg-white pt-4 pb-16 md:pt-8 md:pb-24 overflow-hidden" id="about">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <div className="relative w-full max-w-lg mx-auto" style={{ aspectRatio: '1/0.85' }}>
              {/* Main Large Image */}
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-seafoam text-xs font-bold uppercase tracking-[0.2em]">Why Choose Us</span>
            </div>
