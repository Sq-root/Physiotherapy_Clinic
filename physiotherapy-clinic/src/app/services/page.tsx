    ...
    <section className="relative pt-32 pb-20 overflow-hidden min-h-screen flex flex-col justify-center bg-section">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 w-full mt-10">
        ...
        >
          ...
          >
            A systematic approach to movement. From clinical restoration to high-performance architecture, we engineer your recovery journey with surgical precision.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-10 w-full z-10">
              ...
              <h3 className="text-3xl md:text-4xl text-white font-bold mb-3 tracking-tight">Manual Therapy</h3>
              <p className="text-white/80 text-base font-light max-w-md leading-relaxed">High-precision hands-on mobilization for immediate joint function recalibration.</p>
          ...
          >
            ...
            <div className="relative h-full flex flex-col justify-between p-8">
              <div>
                ...
                <h3 className="text-2xl text-forest font-bold mb-4 tracking-tight">Sports Recovery</h3>
                <p className="text-forest/60 font-light leading-relaxed text-sm">Advanced biomechanical analysis for high-performing athletic architectural restoration.</p>
              </div>
              <div className="mt-6 pt-6 border-t border-forest/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-forest uppercase tracking-widest">Case Milestone</p>
                    <p className="text-[11px] font-serif italic text-forest/70 leading-tight">Return to elite performance in &lt;12 weeks.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative h-full flex flex-col justify-center items-center text-center">
              ...
              <h3 className="text-xl text-forest font-bold tracking-tight">Pain Strategy</h3>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 z-10">
              <span className="text-[9px] text-seafoam font-bold uppercase tracking-[0.3em] mb-2">Technical Rehab</span>
              <h3 className="text-xl text-white font-bold tracking-tight">Post-Surgical</h3>
            </div>
          </motion.div>
        </motion.div>
      </div>
...
function TherapeuticDeepDive() {
  const serviceData = [
    {
      ...
      title: 'Active Aging',
      description: 'Systematic maintenance of independent mobility and structural strength through personalized low-impact protocols.',
      quote: 'Independence is being able to play with my grandkids without structural pain.',
      author: 'Margaret, 72',
    ...
    },
    {
      ...
      title: 'Hydrotherapy',
      description: 'Precision aquatic resistance modeling to facilitate muscle hypertrophy without osteo-articular stress.',
      quote: 'The buoyancy provided a pain-free environment to rebuild my peak power.',
      author: 'David, 45',
    ...
    },
    {
      ...
      description: 'Analytical assessment and resolution of biomechanical imbalances to mitigate long-term injury risks.',
      quote: 'My chronic spinal dysfunction resolved entirely after correcting my base posture.',
      author: 'Sarah, 29',
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      {/* Structural Accent */}
      <div className="absolute top-0 left-0 w-full h-32 bg-section/30" style={{ borderRadius: '0 0 200px 200px' }} />
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            ...
            <p className="text-forest/60 text-lg font-light max-w-xl leading-relaxed">
              An analytical exploration of specialized treatment protocols designed to integrate precisely with your physiological requirements.
            </p>
          </div>
          ...
          {serviceData.map((service, index) => (
            ...
            >
              ...
              <div className="px-5 pb-6">
                <h3 className="text-3xl font-bold text-forest mb-4 tracking-tight group-hover:text-seafoam transition-colors duration-500">{service.title}</h3>
                <p className="text-forest/60 font-light leading-relaxed mb-10 text-base">{service.description}</p>
                ...
                <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-forest/5 relative group-hover:border-seafoam/20 transition-all duration-700">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[13px] italic text-forest font-serif leading-snug">&ldquo;{service.quote}&rdquo;</p>
                      <p className="text-[10px] font-bold text-forest/40 mt-3 uppercase tracking-widest">— {service.author}</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section className="py-24 relative" id="faq">
      ...
      <div className="mx-auto max-w-5xl px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          <span className="text-seafoam font-bold uppercase tracking-[0.3em] text-xs md:text-sm">Clarity</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-4 mb-6 tracking-tight">Common Service Questions</h2>
          <p className="text-white/70 text-base md:text-lg max-w-2xl mx-auto font-light">Understanding your treatment plan is part of the healing process.</p>
        </div>
            ...
            >
              <div className="flex justify-between items-center gap-4">
                ...
                <span className={cn(
                  ...
                  openIndex === index ? "bg-forest text-white" : "bg-seafoam text-forest"
                )}>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-8xl font-bold text-forest mb-8 tracking-tighter">
            Let&apos;s Get <span className="text-transparent bg-clip-text bg-gradient-to-r from-forest to-seafoam">Moving</span>
          </h2>
